...
const scenarioButtons: ScenarioButton[] = [
  {
    id: 'A1',
    name: '昼-单次进入 (C4)',
    description: '白天 10:00 核心 ROI 单次进入，期望 S_cam=50 → P2 → A2，触发 600 s 节流。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'A2',
    name: '昼-12s 内重复进入 (C3)',
    description: '白天同 ROI 12 s 内两次进入，S_cam=60 → P2 → A2，如节流窗口存在应被拒绝。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'A3',
    name: '昼-徘徊 ≥10s (C5)',
    description: '白天 10:10 徘徊 10s，S_cam=55 → P2 → A2。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'A4',
    name: '昼-秒退 (C6)',
    description: '进入后 3 s 内离开且无雷达，S_cam=20 → P3 → 仅 A1。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'A5',
    name: '夜-进入+雷达 (C1)',
    description: '夜间 22:00 越界 + 雷达持续近域，得分≥153 → P1 → A2 并启动 T。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'A6',
    name: '夜-进入+徘徊 (C2)',
    description: '夜间越界后停留，S_cam=60 ×1.5 → 90 → P1 → A2。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'A7',
    name: '夜-秒退但有雷达 (C1 覆盖)',
    description: '越界后 3 s 内离开但雷达近域强信号，仍应 A2。',
    group: 'A｜摄像头路径（C1–C7 全覆盖）',
  },
  {
    id: 'B1a',
    name: '夜-A2 起始',
    description: '夜间 A2 执行并启动 T=300 s，验证状态进入 CHALLENGE。',
    group: 'B｜夜间 A2→T→A3 升级',
  },
  {
    id: 'B1b',
    name: '夜-T 前 60s 摄像仍异常',
    description: 'T 到前 60 s 内再获 S_cam≥50 且无离开，期望 G2 命中 → A3。',
    group: 'B｜夜间 A2→T→A3 升级',
  },
  {
    id: 'B1c',
    name: '夜-T 前 30s 雷达仍异常',
    description: 'T 到前 30 s 雷达 mid_persist/approach_core 阳性 → G2 → A3。',
    group: 'B｜夜间 A2→T→A3 升级',
  },
  {
    id: 'B1d',
    name: '夜-T 内出现离场',
    description: '等待窗末尾出现 cam_leave，期望不升级 A3。',
    group: 'B｜夜间 A2→T→A3 升级',
  },
  {
    id: 'C1-X',
    name: '昼-F1×2 + F2 三强',
    description: '2 个未知 IMSI + 雷达持续/近域/逼近 → P≈81.6，命中 G1-D-X → A2（节流）。',
    group: 'C｜昼间例外闸门 G1-D-X',
  },
  {
    id: 'C2-X',
    name: '昼-F1 重现 + F2 三强',
    description: 'IMSI 重现 + 未知 + 雷达三强 → P≈91.2，例外闸门触发 A2。',
    group: 'C｜昼间例外闸门 G1-D-X',
  },
  {
    id: 'C3-X',
    name: '昼-链路 + F2 三强',
    description: 'F1→F2 链路成立并补齐支撑，期望 P≈91.2 → A2。',
    group: 'C｜昼间例外闸门 G1-D-X',
  },
  {
    id: 'D1',
    name: '昼-同 ROI 600s 内再触发',
    description: '同 ROI 在 600 s 节流内再次越界应被拒绝（仅 A1）。',
    group: 'D｜白天 A2 节流验证',
  },
  {
    id: 'D2',
    name: '昼-不同 ROI 不互斥',
    description: 'ROI-A 在冷却期时 ROI-B 仍可触发 A2。',
    group: 'D｜白天 A2 节流验证',
  },
  {
    id: 'D3',
    name: '昼-雷达扇区节流独立',
    description: '摄像 ROI 节流不影响雷达扇区 G1-D-X。',
    group: 'D｜白天 A2 节流验证',
  },
  {
    id: 'D4',
    name: '夜-节流不生效',
    description: '夜间同 ROI 连续越界均应执行 A2。',
    group: 'D｜白天 A2 节流验证',
  },
  {
    id: 'W1',
    name: 'W1 自动灰名单',
    description: '注入 14 天日间出现记录，期望 IMSI 标记为灰名单候选。',
    group: 'E｜白名单 W 生命周期',
  },
  {
    id: 'W2',
    name: 'W2 自动加白',
    description: '灰名单连续 7 天无夜间活动，期望自动加入白名单（F1=0）。',
    group: 'E｜白名单 W 生命周期',
  },
  {
    id: 'W3',
    name: 'W3 自动撤白',
    description: '白名单 7 天观察内夜间出现或与 F2/F3 关联 → 立即撤白。',
    group: 'E｜白名单 W 生命周期',
  },
  {
    id: 'W4',
    name: 'W4 撤白后再犯',
    description: '撤白后 30 天再犯，触发 90 天禁入自动加白。',
    group: 'E｜白名单 W 生命周期',
  },
  {
    id: 'W5',
    name: 'W5 白名单上限 200',
    description: '一天候选 ≥200 时仅前 200 自动加白，其余顺延。',
    group: 'E｜白名单 W 生命周期',
  },
  {
    id: 'E1',
    name: '协同 ×1.2 生效',
    description: '夜间摄像 + 雷达同窗，期望分值包含协同乘子 → A2。',
    group: 'F｜协同与抑制回归',
  },
  {
    id: 'E2',
    name: '白名单不协同',
    description: '白名单 IMSI + 雷达弱线索，期望无协同加成，仅 A1。',
    group: 'F｜协同与抑制回归',
  },
  {
    id: 'F1',
    name: '<10m 雷达盲区',
    description: '目标在 8 m，仅摄像补盲，应维持 A1。',
    group: 'G｜雷达盲区与仍异常判定',
  },
  {
    id: 'F2',
    name: '12m 近域雷达',
    description: '夜间 12 m 近域雷达持续，期望 P2 → A2。',
    group: 'G｜雷达盲区与仍异常判定',
  },
  {
    id: 'G2-1',
    name: '仍异常：摄像头侧为真',
    description: 'T 内有新 S_cam≥50 且无 leave，期望升级 A3。',
    group: 'G｜雷达盲区与仍异常判定',
  },
  {
    id: 'G2-2',
    name: '仍异常：摄像头侧为假',
    description: 'T 内仅有 cam_leave，无新阳性 → 不升级。',
    group: 'G｜雷达盲区与仍异常判定',
  },
  {
    id: 'G2-3',
    name: '仍异常：雷达侧为真',
    description: 'T 内雷达 mid_persist/approach_core 阳性 → 升级 A3。',
    group: 'G｜雷达盲区与仍异常判定',
  },
]
