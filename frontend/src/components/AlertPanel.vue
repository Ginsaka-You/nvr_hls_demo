...
<template>
  <div class="panel-alerts">
    <a-card v-for="a in alertItems" :key="a.id" size="small" :bordered="true" :bodyStyle="{padding:'8px'}" class="alert-card">
      <div class="alert-row">
...
<style scoped>
.panel-alerts { display:flex; flex-direction:column; gap:8px; }
